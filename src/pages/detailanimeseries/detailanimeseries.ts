...
@Component({
  selector: 'page-detailanimeseries',
  templateUrl: 'detailanimeseries.html',
})
export class DetailanimeseriesPage {
  title:any;
  categorie:any;
  countries: any;
  data_storage:any;
...
/*----------------------------*/
 ...
 /**----------------------------------------- */
  ...
  /**----------------------------------------- */
    ...
    this.JsonDataProvider.getAnimationSeries(this.data_storage,this.categorie)
             .subscribe(
               countries =>{
