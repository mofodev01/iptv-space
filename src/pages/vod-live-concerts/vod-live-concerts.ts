...
@Component({
  selector: 'page-vod-live-concerts',
  templateUrl: 'vod-live-concerts.html',
})
export class VodLiveConcertsPage {
  title:any;
  categorie:any;
  countries: any;
  data_storage:any;
  ...
  ngOnInit() {
   ...
   /**----------------------------------------- */
      ...
      this.storage.get("session_storage").then((res)=>{
       ...
       console.log(this.data_storage);
 /**----------------------------------------- */
this.JsonDataProvider.getVODLiveConcerts(this.data_storage)
             .subscribe(
               countries =>{
